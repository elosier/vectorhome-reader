...
const CACHE_VERSION = 'v2'; // v2: PNG launcher icons (Firefox Android ignores SVG manifest icons)
const SHELL_CACHE = `shell-${CACHE_VERSION}`;
const API_CACHE = `api-${CACHE_VERSION}`;
const SHELL = ['/', '/app.js', '/style.css', '/favicon.svg', '/icons/all-read.svg', '/vendor/qrcode.js', '/manifest.webmanifest'];
